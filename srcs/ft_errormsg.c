...
/*   Updated: 2020/08/29 00:36:29 by sohechai         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
{
    ft_putstr("\033[31mWrong path to the sprite texture\033[00m\n");
...
{
    ft_putstr("\033[31mWrong path to the north texture\033[00m\n");  
    ft_putstr("Please follow this exemple :\n");
...
{
    ft_putstr("\033[31mWrong path to the south texture\033[00m\n");
    ft_putstr("Please follow this exemple :\n");
...
{
    ft_putstr("\033[31mWrong path to the east texture\033[00m\n");
    ft_putstr("Please follow this exemple :\n");
...
{
    ft_putstr("\033[31mWrong path to the west texture\033[00m\n");
    ft_putstr("Please follow this exemple :\n");
